...
internal static class Constants
{
	...
	public const int MaxFormatUInt8Length = 3; // i.e. 255
	public const int MaxFormatUInt16Length = 5; // i.e. 65535
	public const int MaxFormatUInt24Length = 8; // i.e. 16777215
	public const int MaxFormatUInt32Length = 10; // i.e. 4294967295
	public const int MaxFormatUInt48Length = 15; // i.e. 281474976710655
	public const int MaxFormatUInt64Length = 20;  // i.e. 18446744073709551615
	public const int MaxFormatF16Length = 11; // Determined by static analysis for G5
	public const int MaxFormatF32Length = 15; // Determined by static analysis for G9
	public const int MaxFormatF64Length = 128; // default (i.e. 'G'), using 128 (rather than say 32) to be future-proof.

	public const string RoundtripHalfFormat = "G5";
	public const string RoundtripFloatFormat = "G9";
	public const string RoundtripDoubleFormat = "G17";
