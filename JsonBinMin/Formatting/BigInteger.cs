...
namespace JsonBinMin.Formatting
{
    internal static partial class Number
    {
        ...
        internal ref struct BigInteger
        {
            ...
            public static void DivRem(scoped ref BigInteger lhs, scoped ref BigInteger rhs, out BigInteger quo, ref BigInteger rem)
            {
				quo = default;
...
#pragma warning restore CS9080
            ...
            private static uint SubtractDivisor(scoped ref BigInteger lhs, int lhsStartIndex, scoped ref BigInteger rhs, ulong q)
            {
            ...
            public static unsafe void SetValue(out BigInteger result, scoped ref BigInteger value)
            {
				result = default;
                int rhsLength = value._length;

                result._length = rhsLength;
                fixed (void* resultBlocksPtr = &result._blocks.e0, valueBlocksPtr = &value._blocks.e0)
                {
	                // Buffer.Memmove(ref result._blocks[0], ref value._blocks[0], (nuint)rhsLength);
	                Buffer.MemoryCopy(resultBlocksPtr, valueBlocksPtr, rhsLength, rhsLength);
                }
            }
