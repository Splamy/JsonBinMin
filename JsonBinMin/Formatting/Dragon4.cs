...
// This is a port of the `Dragon4` implementation here: https://www.ryanjuckett.com/printing-floating-point-numbers-part-2-dragon4/
    ...
    internal static partial class Number
    {
            ...
            where TNumber : unmanaged, IFloatingPointIeee754<TNumber>
        {
            ...
            if ((mantissa >> Hack<TNumber>.DenormalMantissaBits) != 0)
            {
                mantissaHighBitIdx = Hack<TNumber>.DenormalMantissaBits;
                hasUnequalMargins = (mantissa == (1U << Hack<TNumber>.DenormalMantissaBits));
            }
            else
            {
